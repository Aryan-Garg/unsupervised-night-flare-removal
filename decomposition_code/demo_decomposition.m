function [] = demo_decomposition(imgname, image_dir, save_dirG, save_dirJ)
    ...
    input_i = im2double(imread([image_dir imgname]));
    ...
    imwrite(G*2,  [save_dirG imgname '.jpg']);
    imwrite(J*2,  [save_dirJ imgname '.jpg']);
end
